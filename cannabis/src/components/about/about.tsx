    ...
    return (
      <Host>
        ...
        <p>
          ...
          all of my supplies and buy them again for every grow and it would STILL be cheaper than buying MMJ from a dispensary. The motivation for this site is to learn to use{' '}
          <a href="https://stenciljs.com/" target="_blank">
            StencilJS
          </a>{' '}
          as well as document my cannabis grows. All of my grows use a deep water culture method without any kind of solid media. I first learned this technique from{' '}
